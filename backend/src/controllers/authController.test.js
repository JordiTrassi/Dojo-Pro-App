...
const userMock = require('../models/userMockModel');
...
describe('Given a Register on user function', () => {
...
describe('Given a Login a user function', () => {
  describe('When it is invoked', () => {
    let req;
    let res;
    beforeEach(() => {
...
describe('Given a tokenRefresh function', () => {
  describe('When it is invoked', () => {
    ...
    describe('And tokenRefresh does not contain refreshToken', () => {
      let req;
      let res;
      beforeEach(() => {
        req = {
    ...
    describe('And refreshTokens contains refreshToken', () => {
      ...
      beforeEach(() => {
        ...
        jwt.sign = jest.fn()
          .mockReturnValueOnce('token')
          .mockReturnValueOnce('theRefreshToken');
